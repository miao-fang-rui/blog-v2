...
![TM8760车载机](/产品/车载调度/车载机/TM8760/TM8760-1.jpg)
    ...
    <el-timeline-item placement="top">
      <el-card>
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-1.png"
                alt='语音导入'
                title='语音导入' 
                width="600px"
                height="100%"
    ...
    <el-timeline-item placement="top">
        <el-card>
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-2.png"
                width="300px"
                height="100%"
            />
        </el-card>
    ...
    <el-timeline-item placement="top">
        <el-card>
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-3.png"
                width="600px"
                height="100%"
            />
            <br />
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-4.png"
                width="600px"
                height="100%"
            />
        </el-card>
    ...
    <el-timeline-item placement="top">
        <el-card>
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-6.png"
                width="600px"
                height="100%"
            />
        </el-card>
    ...
    <el-timeline-item placement="top" center>
        <el-card>
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-8.png"
                width="300px"
                height="100%"
            />
            <br />
            ...
            <ElImageI18n 
                ...
                srcTb="/blog-v2/thumb/车载调度/车载机/TM8760/语音导入-9.png"
                width="300px"
                height="100%"
            />
        </el-card>
...
import model_1_tb from '/thumb/车载调度/车载机/TM8760/模块.png'
import model_2_tb from '/thumb/车载调度/车载机/TM8760/模块2.png'

const deviceNetModulePictures = reactive([
    {name: '模块', label:'模块视图1', srcTb: model_1_tb, src: model_1 },
    {name: '模块', label:'模块视图2', srcTb: model_2_tb, src: model_2 },
])
...
import dail_1_tb from '/thumb/车载调度/车载机/TM8760/拨号和信息界面.png'
import dail_2_tb from '/thumb/车载调度/车载机/TM8760/拨号界面.png'
import dail_3_tb from '/thumb/车载调度/车载机/TM8760/IP通话.jpg'
import dail_4_tb from '/thumb/车载调度/车载机/TM8760/信息界面.png'

const devicePhonePictures = reactive([
    {name: '拨号和信息界面', label:'拨号和信息界面', srcTb: dail_1_tb, src: dail_1 },
    {name: '拨号界面', label:'拨号界面', srcTb: dail_2_tb, src: dail_2 },
    {name: 'IP通话界面', label:'IP通话界面', srcTb: dail_3_tb, src: dail_3 },
    {name: '信息界面', label:'信息界面', srcTb: dail_4_tb, src: dail_4 },
])


import vedio_1 from '/产品/车载调度/车载机/TM8760/视频界面.jpg'
import vedio_2 from '/产品/车载调度/车载机/TM8760/视频设置界面.png'
import vedio_1_tb from '/thumb/车载调度/车载机/TM8760/视频界面.jpg'
import vedio_2_tb from '/thumb/车载调度/车载机/TM8760/视频设置界面.png'

const deviceVideoPictures = reactive([
    {name: '视频界面', label:'视频界面', srcTb: vedio_1_tb, src: vedio_1 },
    {name: '视频设置界面', label:'视频设置界面', srcTb: vedio_2_tb, src: vedio_2 },
])


import anjian_1 from '/产品/车载调度/车载机/TM8760/设置按键1.png'
import anjian_2 from '/产品/车载调度/车载机/TM8760/输入密码.png'
import anjian_1_tb from '/thumb/车载调度/车载机/TM8760/设置按键1.png'
import anjian_2_tb from '/thumb/车载调度/车载机/TM8760/输入密码.png'

const deviceSetPictures = reactive([
    {name: '设置按键', label:'设置按键', srcTb: anjian_1_tb, src: anjian_1 },
    {name: '密码页面', label:'密码页面', srcTb: anjian_2_tb, src: anjian_2 },
])

import net_1 from '/产品/车载调度/车载机/TM8760/设置网络参数.png'
import net_2 from '/产品/车载调度/车载机/TM8760/设置调度域名.png'
import net_1_tb from '/thumb/车载调度/车载机/TM8760/设置网络参数.png'
import net_2_tb from '/thumb/车载调度/车载机/TM8760/设置调度域名.png'

const deviceSetNetworkPictures = reactive([
    {name: '设置网络参数', label:'设置网络参数', srcTb: net_1_tb, src: net_1 },
    {name: '设置调度域名', label:'设置调度域名', srcTb: net_2_tb, src: net_2 },
])


import yinliang_1 from '/产品/车载调度/车载机/TM8760/设置-基本设置-音量-1.png'
import yinliang_2 from '/产品/车载调度/车载机/TM8760/设置-基本设置-音量-2.png'
import yinliang_1_tb from '/thumb/车载调度/车载机/TM8760/设置-基本设置-音量-1.png'
import yinliang_2_tb from '/thumb/车载调度/车载机/TM8760/设置-基本设置-音量-2.png'
const deviceVoicePictures = reactive([
    {name: '音量设置', label:'音量设置-1', srcTb: yinliang_1_tb, src: yinliang_1 },
    {name: '音量设置', label:'音量设置-2', srcTb: yinliang_2_tb, src: yinliang_2 },
])
...
import zhuangtai_1_tb from '/thumb/车载调度/车载机/TM8760/状态界面-1.png'
import zhuangtai_2_tb from '/thumb/车载调度/车载机/TM8760/状态-运行参数-1.png'
import zhuangtai_3_tb from '/thumb/车载调度/车载机/TM8760/状态-运行参数-2.png'
import zhuangtai_4_tb from '/thumb/车载调度/车载机/TM8760/状态-运行参数-3.png'
import zhuangtai_5_tb from '/thumb/车载调度/车载机/TM8760/状态-参数版本-1.png'
import zhuangtai_6_tb from '/thumb/车载调度/车载机/TM8760/状态-参数版本-2.png'
import zhuangtai_7_tb from '/thumb/车载调度/车载机/TM8760/状态-系统信息-版本信息.png'
import zhuangtai_8_tb from '/thumb/车载调度/车载机/TM8760/状态-系统信息-设备信息.png'
import zhuangtai_9_tb from '/thumb/车载调度/车载机/TM8760/状态-对接设备-1.png'
import zhuangtai_10_tb from '/thumb/车载调度/车载机/TM8760/状态-对接设备-2.png'
import zhuangtai_11_tb from '/thumb/车载调度/车载机/TM8760/状态-对接设备-3.png'
import zhuangtai_12_tb from '/thumb/车载调度/车载机/TM8760/状态-设备状态-1.png'
import zhuangtai_13_tb from '/thumb/车载调度/车载机/TM8760/状态-设备状态-2.png'
import zhuangtai_14_tb from '/thumb/车载调度/车载机/TM8760/状态-设备状态-3.png'
import zhuangtai_15_tb from '/thumb/车载调度/车载机/TM8760/状态-模块状态-通讯模块.png'
import zhuangtai_16_tb from '/thumb/车载调度/车载机/TM8760/状态-模块状态-无线模块.png'
import zhuangtai_17_tb from '/thumb/车载调度/车载机/TM8760/状态-链接状态.png'

const deviceInfoPictures= reactive([
    {name: '状态菜单', label:'状态菜单', srcTb: zhuangtai_1_tb, src: zhuangtai_1 },
    {name: '运行参数', label:'运行参数-1', srcTb: zhuangtai_2_tb, src: zhuangtai_2 },
    {name: '运行参数', label:'运行参数-2', srcTb: zhuangtai_3_tb, src: zhuangtai_3 },
    {name: '运行参数', label:'运行参数-3', srcTb: zhuangtai_4_tb, src: zhuangtai_4 },
    {name: '参数版本', label:'参数版本-1', srcTb: zhuangtai_5_tb, src: zhuangtai_5 },
    {name: '参数版本', label:'参数版本-2', srcTb: zhuangtai_6_tb, src: zhuangtai_6 },
    {name: '系统信息', label:'系统信息-版本信息', srcTb: zhuangtai_7_tb, src: zhuangtai_7 },
    {name: '系统信息', label:'系统信息-设备信息', srcTb: zhuangtai_8_tb, src: zhuangtai_8 },
    {name: '对接设备', label:'对接设备-1', srcTb: zhuangtai_9_tb, src: zhuangtai_9 },
    {name: '对接设备', label:'对接设备-2', srcTb: zhuangtai_10_tb, src: zhuangtai_10 },
    {name: '对接设备', label:'对接设备-3', srcTb: zhuangtai_11_tb, src: zhuangtai_11 },
    {name: '设备状态', label:'设备状态-1', srcTb: zhuangtai_12_tb, src: zhuangtai_12 },
    {name: '设备状态', label:'设备状态-2', srcTb: zhuangtai_13_tb, src: zhuangtai_13 },
    {name: '设备状态', label:'设备状态-3', srcTb: zhuangtai_14_tb, src: zhuangtai_14 },
    {name: '模块状态', label:'模块状态-通讯模块', srcTb: zhuangtai_15_tb, src: zhuangtai_15 },
    {name: '模块状态', label:'模块状态-无线模块', srcTb: zhuangtai_16_tb, src: zhuangtai_16 },
    {name: '链接状态', label:'链接状态', srcTb: zhuangtai_17_tb, src: zhuangtai_17 },
])
...
import luxiang_3_tb from '/thumb/车载调度/车载机/TM8760/录像界面-录像查询.png'
import luxiang_4_tb from '/thumb/车载调度/车载机/TM8760/录像界面-录像搜索.png' 
import luxiang_5_tb from '/thumb/车载调度/车载机/TM8760/录像界面-录像搜索-回放时间.png'
import luxiang_6_tb from '/thumb/车载调度/车载机/TM8760/录像界面-录像搜索-输入时间.png' 
import luxiang_7_tb from '/thumb/车载调度/车载机/TM8760/录像界面-录像搜索-选择通道.png'
import luxiang_8_tb from '/thumb/车载调度/车载机/TM8760/录像界面-录像搜索-录像回放.png'

const deviceVideoRecordingPictures = reactive([
    // { name: '录像菜单', label:'录像菜单', src: luxiang_1 },
    // { name: '录像界面', label:'录像界面', src: luxiang_2 },
    { name: '录像查询', label:'录像查询', srcTb: luxiang_3_tb, src: luxiang_3 },
    { name: '录像搜索', label:'录像搜索', srcTb: luxiang_4_tb, src: luxiang_4 },
    { name: '回放时间', label:'回放时间', srcTb: luxiang_5_tb, src: luxiang_5 },
    { name: '输入时间', label:'输入时间', srcTb: luxiang_6_tb, src: luxiang_6 },
    { name: '选择通道', label:'选择通道', srcTb: luxiang_7_tb, src: luxiang_7 },
    { name: '录像回放', label:'录像回放', srcTb: luxiang_8_tb, src: luxiang_8 },
])
...
import baozhan_2_tb from '/thumb/车载调度/车载机/TM8760/报站界面.png'
import baozhan_3_tb from '/thumb/车载调度/车载机/TM8760/报站界面-选择线路.png'
import baozhan_4_tb from '/thumb/车载调度/车载机/TM8760/报站界面-GPS调试.png'

const deviceBaozhanToolsPictures = reactive([
    // { name: '报站菜单', label:'报站菜单', src: baozhan_1 },
    { name: '报站界面', label:'报站界面', srcTb: baozhan_2_tb, src: baozhan_2 },
    { name: '选择线路', label:'选择线路', srcTb: baozhan_2_tb, src: baozhan_3 },
    { name: '选择线路', label:'选择线路', srcTb: baozhan_3_tb, src: baozhan_3 },
    { name: 'GPS调试', label:'GPS调试', srcTb: baozhan_4_tb, src: baozhan_4 },
])
...
import wenjian_1_tb from '/thumb/车载调度/车载机/TM8760/文件管理-1.png' 
import wenjian_2_tb from '/thumb/车载调度/车载机/TM8760/文件管理-参数维护.png'
import wenjian_3_tb from '/thumb/车载调度/车载机/TM8760/文件管理-存储管理.png'
import wenjian_4_tb from '/thumb/车载调度/车载机/TM8760/文件管理-升级维护.png'
import wenjian_5_tb from '/thumb/车载调度/车载机/TM8760/文件管理-恢复出厂.png'

const deviceFileManagePictures = reactive([
    { name: '文件管理', label:'文件管理', srcTb: wenjian_1_tb, src: wenjian_1},
    { name: '参数维护', label:'参数维护', srcTb: wenjian_2_tb, src: wenjian_2 },
    { name: '存储管理', label:'存储管理', srcTb: wenjian_3_tb, src: wenjian_3 },
    { name: '升级维护', label:'升级维护', srcTb: wenjian_4_tb, src: wenjian_4 },
    { name: '恢复出厂', label:'恢复出厂', srcTb: wenjian_5_tb, src: wenjian_5 },
])
