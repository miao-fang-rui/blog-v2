...
![TM8765产品图片](/产品/车载调度/车载机/TM8765/TM8765-1.png)
...
![主界面](/产品/车载调度/车载机/TM8765/主界面.png =x500)
...
![运维宝界面](/产品/车载调度/车载机/TM8765/运维宝界面.png)
&nbsp;
![文件管理](/产品/车载调度/车载机/TM8765/文件管理.png)

- 在`sysfile`目录下，会生成一个压缩文件，文件名称 `tm8765_para.zip`, 可以将此配置文件作为通用配置文件导入其他设备。

![sysfile文件夹](/产品/车载调度/车载机/TM8765/sysfile.png)
...
![log文件夹](/产品/车载调度/车载机/TM8765/log.png)
...
![手机APP升级](/产品/车载调度/车载机/TM8765/手机APP升级.png) 
...
![uboot](/产品/车载调度/车载机/TM8765/uboot2.jpg)  
...
![远程升级单片机](/产品/车载调度/车载机/TM8765/远程升级单片机.png)  

#### 3）、 语音文件

压缩为bzqmp3.zip，放到FTP目录下。

![远程升级语音](/产品/车载调度/车载机/TM8765/远程升级语音.png)  
...
![远程升级外设](/产品/车载调度/车载机/TM8765/远程升级外设.png)  
