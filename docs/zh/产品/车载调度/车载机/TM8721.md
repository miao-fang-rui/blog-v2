...
|线束图片|说明|
|:-:|-|
|![1401电源线](/产品/车载调度/车载机/TM8760/1401电源线.png =200x)|**1401电源线**<br /><br />- 两孔插件：接主电源<br />- 三孔插件：接备用电源【从车辆电池直接引过来的线束】|
|![TM8760音视频线束](/产品/车载调度/车载机/TM8760/TM8760音视频线束.png =200x)|**TM8760音视频线束**<br /><br />接摄像头,共三组：<br />- CAMERA 1-4<br />- CAMERA 5-8<br />- CAMERA 9-12|
|![TM8760音频输出线束](/产品/车载调度/车载机/TM8760/TM8760音频输出线束.png =200x)|**TM8760音频输出线束**<br /><br />- 蓝色：提示音<br />- 白色：外音<br />- 红色：内音<br />- 黑色：负极|
|![TM8760通信线](/产品/车载调度/车载机/TM8760/TM8760通信线.png =200x)|**TM8760通信线**<br /><br />两路低速CAN线:<br />- 对接外部设备：天迈路牌、协议转换器、投币机等<br /><br />一路485通讯线:<br />- 对接客流<br /><br />一路高速CAN线:<br />- 对接卡机或者仪表|
|![TM8760信号线](/产品/车载调度/车载机/TM8760/TM8760信号线.png =200x)|**TM8760信号线**<br /><br />开关门信号线：<br />- 蓝色：前门开关门<br />- 白色：后门开关门<br />- 红色ACC：钥匙信号<br />- 红色倒车：倒车信号<br />- 报警信号线：接一键报警开关<br />- 转弯信号线|
|![TM8760显示屏延长线](/产品/车载调度/车载机/TM8760/TM8760显示屏延长线.png =200x)|**TM8760显示屏延长线**<br /><br />- 接8832显示屏|

### 5、TM8832显示屏

![TM8832显示屏](/产品/车载调度/车载机/TM8760/TM8832显示屏.png =500x)

![TM8832显示屏-背面](/产品/车载调度/车载机/TM8760/TM8832显示屏-背面.png =500x)
...
|图标|说明|备注|
|:-:|---|---|
|![信号强度](/产品/车载调度/车载机/TM8760/信号强度.png =24x)|信号强度||
|![定位](/产品/车载调度/车载机/TM8760/定位.png =22x)|定位||
|![调度服务器](/产品/车载调度/车载机/TM8760/调度服务器.png =24x)|调度服务器|调度服务器注册成功|
|![机械硬盘](/产品/车载调度/车载机/TM8760/机械硬盘.png =24x)|机械硬盘|机械硬盘挂载成功|
|![视频服务器](/产品/车载调度/车载机/TM8760/视频服务器.png =30x)|视频服务器|视频服务器注册成功|
|![SSD固态硬盘](/产品/车载调度/车载机/TM8760/SSD固态硬盘.png =30x)|SSD固态硬盘|SSD固态硬盘挂载成功|
|![下行第十四站](/产品/车载调度/车载机/TM8760/下行第十四站.png =70x)|下行第十四站||
|![趟次](/产品/车载调度/车载机/TM8760/趟次.png =50x)|趟次||
|![限速值](/产品/车载调度/车载机/TM8760/限速值.png =30x)|圆圈内的数值为限速值：50<br />下面是当前实时速度：20.1||
...
|图标|页面|功能说明|
|:-:|:-:|-|
|![报警按键](/产品/车载调度/车载机/TM8760/报警按键.png =52x50)|![一键报警界面](/产品/车载调度/车载机/TM8760/一键报警界面.png =300x)|**报警按键**：<br /><br />给调度中心发送危机报警信息|
...
|图标|页面|功能说明|
|:-:|:-:|-|
|![宣传用语按键](/产品/车载调度/车载机/TM8760/宣传用语按键.png =52x50)|![宣传用语界面](/产品/车载调度/车载机/TM8760/宣传用语界面.png =300x)|**宣传用语按键**:<br /><br />1、播报宣传语音 <br />2、外音喊话<br />3、播报转弯用语|
...
|图标|页面|功能说明|
|:-:|:-:|-|
|![事件按键](/产品/车载调度/车载机/TM8760/事件按键.png =62x50)|![事件按键界面](/产品/车载调度/车载机/TM8760/事件按键界面.png =300x)|**事件按键**：<br /><br />给调度中心发送相应的事件信息： <br />1、堵车事件<br />2、报警事件<br />3、故障事件<br />4、事故事件<br />5、加油事件<br />6、包车事件<br />7、加油事件|

### 5、拨号和信息按键

|图标|页面|功能说明|
|-|-|-|
|![拨号和信息按键](/产品/车载调度/车载机/TM8760/拨号和信息按键.png =52x50)|<Carousel :pictures='devicePhonePictures' height='200px' />|**拨号和信息按键**：<br /><br />1、与调度中心互相拨打电话<br />2、呼叫白名单中的电话号码<br />3、给调度中心IP通话请求<br />4、查看调度中心发过来的信息|

### 6、视频按键

|图标|页面|功能说明<div style='width: 20%'></div>|
|:-:|:-:|-|
|![视频按键](/产品/车载调度/车载机/TM8760/视频按键.png =52x50)|![视频按键](/产品/车载调度/车载机/TM8760/视频界面.png =300x)<br />![视频按键](/产品/车载调度/车载机/TM8760/视频设置界面.png =300x)|**视频按键**：<br /><br />1、查看视频画面<br /><br />2、查看录像状态是否正常<br />&nbsp;&nbsp;&nbsp;&nbsp;红色方块 ' ![录像方块](/产品/车载调度/车载机/TM8760/录像方块.png =12x12) '表示录像正常<br /><br />3、单画面：单个通道循环显示<br /><br />4、四画面：四个通道循环显示<br /><br />5、抓拍：抓拍对应通道的图片<br /><br />6、设置：设置各通道色彩<br /><br />7、复制：复制到其他通道参数<br /><br />8、默认：恢复出厂时的色彩信息|

## 六、菜单界面

|图标|按键|功能说明|
|-|-|-|
|![菜单按键](/产品/车载调度/车载机/TM8760/主页菜单按键.png =52x50)|![菜单界面](/产品/车载调度/车载机/TM8760/主页菜单界面.png =300x)|**菜单按键**：<br /><br />1、录像：查看、导出录像<br />2、状态：查看车载机状态信息<br />3、报站：测试报站语音<br />4、设置：设置车载机参数<br />5、文件：<br />&nbsp;&nbsp;&nbsp;&nbsp;①、管理语音文件、硬盘、SSD<br />&nbsp;&nbsp;&nbsp;&nbsp;②、程序升级<br />&nbsp;&nbsp;&nbsp;&nbsp;③、恢复出厂<br />6、客流：客流信息设置<br />&nbsp;&nbsp;&nbsp;&nbsp;需要刷对接客流的程序|
...
<Carousel :pictures='deviceVideoRecordingPictures' :height='"300px"' />
...
<Carousel :pictures='deviceInfoPictures' :height='"300px"' />
...
<Carousel :pictures='deviceBaozhanToolsPictures' :height='"300px"' />
...
|信号量|说明|
|:-:|-|
|![设置车辆信息](/产品/车载调度/车载机/TM8760/设置车辆编号.png =300x)|**注册**：设置车辆参数信息<br /><br />1、车牌号是调度平台下发的，不需要设置。<br />2、车载机编号是出厂的唯一编号，不允许修改。|
|<Carousel :pictures='deviceVoicePictures' height="300px" />|**音量**：设置设备的音量大小<br /><br />1、报站音量<br />2、喊话音量<br />3、GSM通话音量<br />4、IP通话音量<br />5、TTS音量|
|<Carousel :pictures='deviceSetNetworkPictures' height="300px" />|**网络**：该参数由项目经理或者运维提供<br /><br />1、主调度服务器IP / 端口<br />2、副调度服务器IP / 端口<br />3、主视频服务器IP / 端口<br />4、副视频服务器IP / 端口<br />5、设置调度域名和端口<br /><br />说明：<br /><br />1、【视频服务器域名和端口暂时不要设置，端口设置为0，默认不启用】<br />2、【卡机服务器根据现场情况设置】|
|![信号量1](/产品/车载调度/车载机/TM8760/信号量1.png =300x)|1、**倒车通道**：挂倒挡时要切换到的视频画面<br /><br />2、**右前门通道**：打开右前门时要切换到的视频画面<br /><br />3、**右后门通道**：打开右后门时要切换到的视频画面<br /><br />4、**左前门通道**：打开左前门时要切换到的视频画面<br /><br />5、**左后门通道**：打开左后门时要切换到的视频画面<br /><br />6、**后门通道切换触发方式**：<br />&nbsp;&nbsp;①、司机开门：司机手动触发开门时触发<br />&nbsp;&nbsp;②、进站开门：车载机到达进站半径自动切换，此方式要求经纬度描点时准确<br />&nbsp;&nbsp;③、组合方式：①和②共同起作用<br /><br />7、**后门单双门开门配置**：根据现场车型设置是单侧开门还是双侧开门<br /><br />8、**左转弯通道**：打左转向时要切换到的视频画面<br /><br />9、**右转弯通道**：打右转向时要切换到的视频画面|
|![信号量2](/产品/车载调度/车载机/TM8760/信号量2.png =300x)|10、**发车点**：默认‘长显示’：<br /><br />&nbsp;&nbsp;①、长显示：默认，车载机收到下一个发车点后，将之前的覆盖<br />&nbsp;&nbsp;②、短显示：车辆发车后消失<br />&nbsp;&nbsp;③、不显示<br /><br />11、**运行趟次**：与发车点相同，默认'长显示'<br />12、**开机界面**：可设置【调度界面、视频界面】|
|![信号量3](/产品/车载调度/车载机/TM8760/信号量3.png =300x)|13、**屏类型(根据协议选择)**：<br />&nbsp;&nbsp;①、天迈屏；<br />&nbsp;&nbsp;②、第三方屏<br /><br />14、**线路类型**：选择通用线路<br /><br />15、**左右转弯信号源**：根据现场情况选择<br />&nbsp;&nbsp;①、IO：高低电平信号<br />&nbsp;&nbsp;②、仪表：取仪表数据中的信号<br /><br />16、**门信号类型**：<br />&nbsp;&nbsp;①、高电平：开门时门信号输出高电平<br />&nbsp;&nbsp;②、低电平：开门时门信号输出低电平<br /><br />17、**开门信号**：<br />&nbsp;&nbsp;①、电平：开门后，门信号上一直有电压<br />&nbsp;&nbsp;②、脉冲：开门时，门信号上有一瞬间的电压|

#### **②、视频设置**

|视频设置|说明|
|:-:|-|
|![输出参数](/产品/车载调度/车载机/TM8760/视频设置-输出参数.png =300x)|**输出参数**：<br /><br />设置的是显示屏上面，视频通道的画面亮度、色调、对比度、饱和度|
|![录像通道](/产品/车载调度/车载机/TM8760/视频设置-录像通道.png =300x)|**录像通道**：<br /><br />设置需要哪个通道录像，车载机安装有几路摄像头，就勾选几个通道<br /><br />备注：如果没有安装摄像头的通道也勾选，那么该路摄像头也会录像，占用硬盘空间|
|![镜像](/产品/车载调度/车载机/TM8760/视频设置-镜像.png =300x)|**镜像**：<br /><br />设置某个通道左右翻转|
|![翻转](/产品/车载调度/车载机/TM8760/视频设置-翻转.png =300x)|**翻转**：<br /><br />设置某个通道上下翻转|
|![其他](/产品/车载调度/车载机/TM8760/视频设置-其他.png =300x)|**其他**：<br /><br />1、视频默认通道：<br /> - 手动按‘视频’按键，进入视频界面后默认显示的通道<br /><br />2、拍照默认通道：<br /> - 在视频界面点击‘抓拍’按键，抓拍该通道的图片|

#### **③、通讯设置**

|通讯设置|说明|
|:-:|-|
|![拨号设置](/产品/车载调度/车载机/TM8760/通讯设置.png =300x)|**拨号设置**：<br /><br />1、网络模式：全网通，默认‘自动’>。<br /><br />2、接入点：默认‘3gnet’，如果客户使用专网卡，需要设置此处为特殊的接入点，运营商会提供。<br /><br />3、输入音量，输出音量：调整通讯模块的音量，一般不需要调整。<br /><br />4、通话时长：调整GSM通话时间，默认不需要调整。|
|![通讯设置-无线设置](/产品/车载调度/车载机/TM8760/通讯设置-无线设置.png =300x)|**无线设置**：<br /><br />- 车载机无线WIFI信息|
|![通讯设置-定位模块](/产品/车载调度/车载机/TM8760/通讯设置-定位模块.png =300x)|**定位模块**：<br /><br />- 未启用|
...
|文件|说明|
|:-:|-|
|![文件管理-参数维护](/产品/车载调度/车载机/TM8760/文件管理-参数维护.png =260x)|**参数维护**：<br /><br />1、系统参数导入/导出<br />2、客流参数导入<br />3、360环视参数导入<br />4、协议转换器参数导入|
|![文件管理-存储管理](/产品/车载调度/车载机/TM8760/文件管理-存储管理.png =260x)|**存储管理**：<br /><br />1、U盘格式化<br />2、HDD硬盘的修复和格式化<br />3、SSD固态盘的修复和格式化<br />4、2.5SSD的修复和格式化（不常用）<br />5、SSD录像同步|
|![文件管理-升级维护](/产品/车载调度/车载机/TM8760/文件管理-升级维护.png =260x)|**升级维护**：<br /><br />1、核心板程序升级和重启<br />2、单片机程序的升级和重启<br />3、语音文件的升级和导出<br />4、客流相机的升级|
|![文件管理-恢复出厂](/产品/车载调度/车载机/TM8760/文件管理-恢复出厂.png =260x)|**恢复出厂**：<br /><br />1、恢复调度配置<br />2、恢复线路配置|
